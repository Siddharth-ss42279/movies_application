...
public class Tab2 extends Activity {
	...
	private void setNowPlayingList() {
		// TODO Auto-generated method stub
		try {

			dialog = ProgressDialog.show(Tab2.this, "",
			...
			new Thread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					JSONData h = new JSONData(Tab2.this);
					try {
						if (Utlity.isOnline(Tab2.this)) {
							
							
							topRatedList = h.getAlbumList(pageNo,"upcoming");
							...
							if (topRatedList == null) {
								...
								mHandler.post(new Runnable() {
									@Override
									public void run() {
										Toast.makeText(Tab2.this,	"No Data Found",Toast.LENGTH_LONG).show();
										if (dialog != null && dialog.isShowing())
											dialog.dismiss();
										loadingMore = false;
										mainListAdapter = new NewRelAdapter(Tab2.this,topRatedList);
									...
									public void run() {
										...
										mainList.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(AdapterView<?> parent, View view, int position,
												...
												{
													Intent i = new Intent(Tab2.this,DataPage.class);
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(Tab2.this,	"No Network Detected",Toast.LENGTH_LONG).show();
									dialog.dismiss();
								}
							});
						}
