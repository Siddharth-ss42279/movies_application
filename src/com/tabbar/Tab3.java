...
public class Tab3 extends Activity{
	...
	private void setNewReleaseList() {
		// TODO Auto-generated method stub
		
		try {

			dialog = ProgressDialog.show(Tab3.this, "",
			...
			new Thread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					JSONData h = new JSONData(Tab3.this);
					try {
						if (Utlity.isOnline(Tab3.this)) {
							
							
							topRatedList = h.getAlbumList(pageNo,"popular");
							...
							if (topRatedList == null) {
								...
								mHandler.post(new Runnable() {
									@Override
									public void run() {
										Toast.makeText(Tab3.this,	"No Data Found",Toast.LENGTH_LONG).show();
										if (dialog != null && dialog.isShowing())
											dialog.dismiss();
										loadingMore = false;
										mainListAdapter = new NewRelAdapter(Tab3.this,topRatedList);
									...
									public void run() {
										...
										mainList.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(
												...
												{
													Intent i = new Intent(Tab3.this,DataPage.class);
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(Tab3.this,	"No Network Detected",Toast.LENGTH_LONG).show();
									dialog.dismiss();
								}
							});
						}
